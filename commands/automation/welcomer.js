...
function getBuiltInWelcomerTemplates() {
    return {
        'cv2-modern-frost': {
            ...
            template: {
                mode: 'components',
                content: '# 👋 Welcome {user}\n{separator:small}\n**{server}** is glad to have you here!\nYou are member **#{membercount}**.',
                color: '#bcf1e4',
                colorless: false,
                image: 'https://images.unsplash.com/photo-1519750783826-e2420f4d687f?auto=format&fit=crop&w=1400&q=80',
                thumbnail: '{useravatar}',
                footer: 'Account created: {usercreated}',
                imagePosition: 'top',
                buttons: [
                    { label: 'Read Rules', url: 'https://discord.com/channels/{serverid}/rules' },
                    { label: 'Get Roles', url: 'https://discord.com/channels/{serverid}/roles' }
                ],
        ...
        'cv2-clean-sidebar': {
            ...
            template: {
                mode: 'components',
                content: '### Welcome, {displayname}!\n{separator:small}\nPlease check the server guide and say hello in chat.',
                color: '#7289da',
                colorless: false,
        ...
        'cv2-canvas-spotlight': {
            name: 'CV2 • Canvas Spotlight',
            template: {
                mode: 'components',
                ...
                canvas: {
                    ...
                    accentColor: '#57f287',
                    textColor: '#ffffff',
                    customMessage: 'Member #{membercount}'
                }
            }
        },
        'cv2-community-hub': {
            ...
            template: {
                ...
                thumbnail: '{useravatar}',
                footer: 'Boost tier: {boosttier} • Members: {membercount}',
                imagePosition: 'bottom',
                buttons: [
                    { label: 'Rules', url: 'https://discord.com/channels/{serverid}/rules' },
                    { label: 'Announcements', url: 'https://discord.com/channels/{serverid}/announcements' }
                ],
                canvas: { enabled: false }
            }
        },
        ...
        'embed-professional-blue': {
            ...
            template: {
                ...
                content: 'Please welcome **{displayname}** to **{server}**.\nJoined: {userjoined}',
                color: '#5865f2',
        ...
        'embed-minimal-clean': {
            ...
            template: {
                ...
                content: 'You are now part of **{server}**.\nHave a great time!',
                color: '#99aab5',
                thumbnail: '{useravatar}',
        ...
        'embed-premium-gold': {
            ...
            template: {
                mode: 'embed',
                title: '⭐ Welcome to the Premium Community',
                content: 'A warm welcome to {user}.\nServer: **{server}**\nBoosts: **{boostcount}**',
                color: '#faa61a',
    ...
    return {
        'cv2-farewell-clean': {
            ...
            template: {
                ...
                colorless: false,
                thumbnail: '{useravatar}',
                footer: 'We are now {membercount} members',
                imagePosition: 'bottom',
                canvas: { enabled: false }
            }
        },
        'cv2-soft-red': {
            ...
            template: {
                ...
                color: '#ff6b6b',
                colorless: false,
                image: 'https://images.unsplash.com/photo-1477511614005-9962a32cc4c6?auto=format&fit=crop&w=1400&q=80',
                thumbnail: '{servericon}',
                footer: 'Left at {userjoined}',
                imagePosition: 'top',
                canvas: { enabled: false }
            }
        },
        'cv2-colorless-minimal': {
            name: 'CV2 • Colorless Minimal',
            template: {
                mode: 'components',
        ...
        'cv2-canvas-memory': {
            name: 'CV2 • Canvas Memory',
            template: {
                mode: 'components',
                content: 'A member has left **{server}**.\n{separator:small}\nTake care, {username}.',
                color: '#c0392b',
                colorless: false,
                thumbnail: '{servericon}',
                footer: 'Current members: {membercount}',
                imagePosition: 'bottom',
                canvas: {
                    enabled: true,
                    backgroundColor: '#1e1f22',
                    accentColor: '#ed4245',
                    textColor: '#ffffff',
                    customMessage: 'We hope to see you again'
                }
            }
        },
        'cv2-community-signoff': {
            name: 'CV2 • Community Signoff',
            template: {
                mode: 'components',
                content: '## 👋 Farewell {username}\nThanks for spending time with us in **{server}**.\n{separator:small}\nDoors are always open.',
                color: '#f04747',
                colorless: false,
                image: 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?auto=format&fit=crop&w=1400&q=80',
                thumbnail: '{useravatar}',
                footer: 'Member count: {membercount}',
                imagePosition: 'bottom',
                buttons: [
                    { label: 'Rejoin Server', url: 'https://discord.gg/example' }
                ],
                canvas: { enabled: false }
            }
        },
        'embed-classic-farewell': {
            name: 'Embed • Classic Farewell',
            template: {
                mode: 'embed',
                title: 'Member Left',
                content: '{user} has left **{server}**.\nWe now have **{membercount}** members.',
                color: '#ED4245',
                thumbnail: '{useravatar}',
                footer: 'Good luck on your journey'
            }
        },
        'embed-professional-goodbye': {
            name: 'Embed • Professional Goodbye',
            template: {
                mode: 'embed',
                ...
                thumbnail: '{servericon}',
                footer: 'Remaining members: {membercount}',
                author: '{server} System'
            }
        },
        'embed-minimal-muted': {
            name: 'Embed • Minimal Muted',
            template: {
                mode: 'embed',
                title: 'Goodbye {username}',
                content: 'Thank you for being with us in **{server}**.',
                color: '#747f8d',
                thumbnail: '{useravatar}',
                footer: 'Current count: {membercount}'
            }
        },
        'embed-nightfarewell': {
            name: 'Embed • Night Farewell',
            template: {
                mode: 'embed',
                title: '🌙 Farewell',
                content: '{user} has signed off from **{server}**.',
                color: '#992d22',
                image: 'https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=1400&q=80',
                thumbnail: '{useravatar}',
                footer: 'We wish you all the best'
            }
        },
        'embed-premium-crimson': {
            name: 'Embed • Premium Crimson',
            template: {
                mode: 'embed',
                title: '⭐ Premium Farewell',
                content: '{username} has left the premium community of **{server}**.\nBoosts: **{boostcount}**',
                color: '#e74c3c',
                image: 'https://images.unsplash.com/photo-1501426026826-31c667bdf23d?auto=format&fit=crop&w=1400&q=80',
                thumbnail: '{servericon}',
                footer: 'Member #{membercount}',
                author: 'Leave Tracker'
            }
        }
    };
}
